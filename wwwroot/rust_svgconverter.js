...
* @returns {string}
*/
export function image_to_path(image_data, threshold) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.image_to_path(retptr, ptr0, len0, threshold);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_svgconverter_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
